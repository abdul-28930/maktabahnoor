      ...
      <header id="top" style={{position:'relative',zIndex:1,minHeight:'100vh',display:'flex',alignItems:'center',padding:'140px clamp(20px,5vw,72px) 130px'}}>
        ...
        <div className="hp-hero-grid" style={{position:'relative',zIndex:2,width:'100%',maxWidth:1320,margin:'0 auto',display:'grid',gridTemplateColumns:'1.4fr 1fr',gap:48,alignItems:'center'}}>
          <div>
            ...
            <p className="hp-hero-anim" style={{opacity:0,animation:'heroFadeUp .7s ease 1.05s both',margin:'0 0 34px',fontSize:14.5,lineHeight:1.7,color:'#6b6460',maxWidth:440,fontWeight:300}}>Spreading beneficial knowledge — Qurans, Islamic Books &amp; Essentials. Shipping worldwide.</p>
      ...
      <section style={{position:'relative',zIndex:1,background:'#f4f1e9',borderTop:'1px solid rgba(27,67,50,0.08)',padding:'64px clamp(20px,5vw,72px)',textAlign:'center',overflow:'hidden'}}>
        ...
        <div className="hp-reveal" style={{position:'relative',maxWidth:640,margin:'0 auto'}}>
          <div style={{fontSize:10,letterSpacing:'3px',textTransform:'uppercase',color:'#b8965a',marginBottom:16,display:'flex',alignItems:'center',justifyContent:'center',gap:10}}>
            <span style={{width:24,height:1,background:'#b8965a',display:'inline-block'}}/>✦ Order via WhatsApp<span style={{width:24,height:1,background:'#b8965a',display:'inline-block'}}/>
          </div>
          ...
          <p style={{margin:'0 0 32px',fontSize:15,color:'#6b6460',lineHeight:1.75,fontWeight:300}}>Browse our collection, add books to your cart, and send us your order on WhatsApp. We confirm availability and dispatch swiftly, worldwide.</p>
          <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:14,flexWrap:'wrap'}}>
            <a href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Assalamualaikum! I would like to place an order.')}`} target="_blank" rel="noreferrer" style={{textDecoration:'none',display:'inline-flex',alignItems:'center',gap:10,background:'#1b4332',color:'#fff',padding:'15px 30px',borderRadius:40,fontSize:14,letterSpacing:.4,boxShadow:'0 6px 24px rgba(27,67,50,0.2)'}}>
        ...
        <div style={{position:'relative',zIndex:1,maxWidth:1200,margin:'0 auto',padding:'72px clamp(20px,5vw,72px) 0',display:'grid',gridTemplateColumns:'1.6fr 1fr 1fr 1.2fr',gap:48}}>
          ...
          <div>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:14}}>
              {['Browse our collection online','Add books to your cart','We confirm & share the total on WhatsApp','Packed & dispatched worldwide'].map((step,i)=>(
            ...
            <div style={{marginTop:24,paddingTop:20,borderTop:'1px solid rgba(255,255,255,0.08)',display:'flex',flexDirection:'column',gap:12}}>
              <a href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Assalamualaikum! I have a question about your books.')}`} target="_blank" rel="noreferrer"
                style={{display:'inline-flex',alignItems:'center',gap:10,padding:'11px 20px',background:'rgba(184,150,90,0.15)',border:'1px solid rgba(184,150,90,0.35)',borderRadius:30,textDecoration:'none',color:'#d4ab70',fontSize:13,letterSpacing:.4,transition:'background .2s',width:'fit-content'}}
              ...
              <a href={`mailto:${EMAIL}`} style={{color:'rgba(255,255,255,0.65)',fontSize:13,textDecoration:'none',fontWeight:300}}>{EMAIL}</a>
              <a href={`tel:${PHONE_DISPLAY.replace(/\s+/g,'')}`} style={{color:'rgba(255,255,255,0.65)',fontSize:13,textDecoration:'none',fontWeight:300}}>{PHONE_DISPLAY}</a>
            </div>
          </div>
        </div>
