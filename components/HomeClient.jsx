    ...
    <div ref={rootRef} style={{position:'relative',minHeight:'100vh',background:'#faf9f5',color:'#1a1712',fontFamily:"'DM Sans',sans-serif",overflowX:'hidden',animation:'pageFade .5s ease both'}}>
      ...
      <section style={{position:'relative',zIndex:1,background:'#f4f1e9',borderTop:'1px solid rgba(27,67,50,0.08)',padding:'64px clamp(20px,5vw,72px)',textAlign:'center',overflow:'hidden'}}>
        ...
        <div className="hp-reveal" style={{position:'relative',maxWidth:640,margin:'0 auto'}}>
          ...
          <p style={{margin:'0 0 32px',fontSize:15,color:'#6b6460',lineHeight:1.75,fontWeight:300}}>Browse our collection, add books to your cart, and send us your order on WhatsApp. We confirm availability and dispatch swiftly across India.</p>
        ...
        <div style={{position:'relative',zIndex:1,maxWidth:1200,margin:'0 auto',padding:'72px clamp(20px,5vw,72px) 0',display:'grid',gridTemplateColumns:'1.6fr 1fr 1fr 1.2fr',gap:48}}>
          ...
          <div>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:14}}>
              {['Browse our collection online','Add books to your cart','We confirm & share the total on WhatsApp','Packed & dispatched across India'].map((step,i)=>(
