...
export const MANDATORY_BOOK_FIELDS = ['title', 'author', 'category', 'language', 'price'];
export const OPTIONAL_BOOK_FIELDS  = [
  'translator', 'sku', 'description', 'volumes', 'binding',
  'pages', 'mrp', 'offerType', 'stockCount', 'tags', 'coverUrl', 'gallery',
];
...
export const WA_NUMBER = '819943917887';
